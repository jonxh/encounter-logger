 ...
 */
@Slf4j
@PluginDescriptor(name = "Encounter Logger", description = "Records raw encounter data (NPCs, projectiles, animations, hitsplats, etc.) as JSONL.", tags = {
        "data", "recording", "npc", "boss", "simulator" })
public class EncounterLoggerPlugin extends Plugin {
    @Inject
    private Client client;
    @Inject
    private EncounterLoggerConfig config;
    @Inject
    private Gson gson;
    ...
    public void onNpcSpawned(NpcSpawned e) {
        if (recorder != null && recorder.isRecording())
            recorder.onNpcSpawned(e);
    }

    @Subscribe
    public void onNpcDespawned(NpcDespawned e) {
        if (recorder != null && recorder.isRecording())
            recorder.onNpcDespawned(e);
    }
    ...
    public void onChatMessage(ChatMessage e) {
        if (recorder != null && recorder.isRecording())
            recorder.onChatMessage(e);
    }

    @Subscribe
    public void onOverheadTextChanged(OverheadTextChanged e) {
        if (recorder != null && recorder.isRecording())
            recorder.onOverheadTextChanged(e);
    }
    ...
    public void onItemSpawned(ItemSpawned e) {
        if (recorder != null && recorder.isRecording())
            recorder.onItemSpawned(e);
    }

    @Subscribe
    public void onItemDespawned(ItemDespawned e) {
        if (recorder != null && recorder.isRecording())
            recorder.onItemDespawned(e);
    }
    ...
    public void onSoundEffectPlayed(SoundEffectPlayed e) {
        if (recorder != null && recorder.isRecording())
            recorder.onSoundEffectPlayed(e);
    }

    @Subscribe
    public void onAreaSoundEffectPlayed(AreaSoundEffectPlayed e) {
        if (recorder != null && recorder.isRecording())
            recorder.onAreaSoundEffectPlayed(e);
    }

    @Subscribe
    public void onVarbitChanged(VarbitChanged e) {
        if (recorder != null && recorder.isRecording())
            recorder.onVarbitChanged(e);
    }
    ...
    public void onMenuOptionClicked(MenuOptionClicked e) {
        if (recorder != null && recorder.isRecording())
            recorder.onMenuOptionClicked(e);
    }
