...
public final class EncounterJson {
    ...
    public static Map<String, Object> npcCompositionSnapshot(int combatLevel, int size, String[] actions, int transformedId) {
        Map<String, Object> m = new LinkedHashMap<>();
        m.put("combatLevel", combatLevel);
        m.put("size", size);
        m.put("actions", actions);
        m.put("transformedId", transformedId);
        return m;
    }
    ...
    public static Map<String, Object> graphicsObjectSnapshot(
            ...
            int worldX, int worldY, int plane,
            int sceneX, int sceneY,
            int height, int startCycle, int duration) {
        Map<String, Object> m = new LinkedHashMap<>();
        m.put("id", id);
        m.put("worldLocation", worldPoint(worldX, worldY, plane));
        m.put("sceneLocation", localPoint(sceneX, sceneY, plane));
    ...
    public static Map<String, Object> sceneObjectSnapshot(
        ...
        m.put("id", id);
        m.put("objectKey", category + ":" + id + ":" + worldX + ":" + worldY + ":" + plane);
        m.put("name", name);
        m.put("worldLocation", worldPoint(worldX, worldY, plane));
        m.put("sizeX", sizeX);
        m.put("sizeY", sizeY);
